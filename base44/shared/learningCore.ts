...
// self-learning loop. Imported by the server-side learning-cycle function
// (scheduled + manual) and by the automated regression tests
// (src/__tests__/learningLoop.test.js) — the tests prove the SAME code the
// production cycle runs. No SDK, no I/O: everything here is deterministic
// and testable.
//
